...
namespace A2_Reg_A_Lot_2017
{
    public partial class UpdateRegistrar : Form
    {
        ...
        private void btnEditRegistrar_Click(object sender, EventArgs e)
        {
        ...
        private void btnCreateRegistrar_Click(object sender, EventArgs e)
        {
            CreateNewRegistrar frm = new CreateNewRegistrar();
            frm.Show();
